 ...
 * {@link androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup} instance via
 * {@link DpadGridLayoutManager#setSpanSizeLookup(GridLayoutManager.SpanSizeLookup)}.
 */
public class DpadGridLayoutManager extends DpadLinearLayoutManager {
     ...
     */
    public DpadGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                 int defStyleRes) {
     ...
     */
    public DpadGridLayoutManager(Context context, int spanCount) {
        super(context);
     ...
     *
     * @param spanSizeLookup {@link androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup}
    ...
    /**
     * Returns the current {@link androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup} used by the GridLayoutManager.
     *
     * @return The current {@link androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup} used by the GridLayoutManager.
     */
     ...
     * more calls to {@link GridLayoutManager.SpanSizeLookup#getSpanGroupIndex(int, int)}".
     *
     ...
     *   <li>Calls to {@link GridLayoutManager.SpanSizeLookup#getSpanGroupIndex(int, int)} are fast.
     * </ul>
     *
     * <p>If you decide to enable this feature, you should be sure that calls to
     * {@link GridLayoutManager.SpanSizeLookup#getSpanGroupIndex(int, int)} are fast, that set span group index
     * caching is set to true via a call to
     * {@link GridLayoutManager.SpanSizeLookup#setSpanGroupIndexCacheEnabled(boolean),
     * and span index caching is also enabled via a call to
     * {@link GridLayoutManager.SpanSizeLookup#setSpanIndexCacheEnabled(boolean)}}.
     */
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
         ...
         * {@link androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup#getSpanIndex(int, int)}.
         * <p>
