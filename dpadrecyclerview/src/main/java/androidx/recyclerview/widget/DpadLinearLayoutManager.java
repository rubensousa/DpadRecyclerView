 ...
 */
public class DpadLinearLayoutManager extends RecyclerView.LayoutManager implements
     ...
     */
    public DpadLinearLayoutManager(
    ...
    public DpadLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                   int defStyleRes) {
     ...
     */
    protected boolean updateAnchorFromChildren(RecyclerView.Recycler recycler,
