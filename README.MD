...
```groovy
implementation "com.rubensousa.dpadrecyclerview:dpadrecyclerview:$latest"
androidTestImplementation "com.rubensousa.dpadrecyclerview:dpadrecyclerview-testing:$latest"
```
